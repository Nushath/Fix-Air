                ...
                <div className="column2">
                    <div className="seatInfo">
                        ...
                        <div className='seat-btns'>
                            <button onClick={e => handleSubmitDetails(e)} className="confirm-btn">
                              <Link className='confirm-btn' to="/payment">Confirm Details</Link>
                            </button>
                            <button onClick={e => handleSubmitDetails(e)} className="cancel-btn">
